...
final int EVENT_10=10;               //Maps to stops on route Screen, screen7
final int EVENT_11=11;               //Maps to stops on route Screen, screen7
final int EVENT_12=12;               //Maps to stops on route Screen, screen7
...
final int query11=11;
final int query12=12;
final int query13=13;
final int noQuery=123;
final float centreLatitude=  53.350140*(PI/180);
final float centreLongitude=  -6.266155*(PI/180);